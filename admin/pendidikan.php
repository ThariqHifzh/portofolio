            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class=" mb-4 text-white" align="center">
                        <h3 class="fw-bold" style="letter-spacing: 30px;">PENDIDIKAN</h1>
                    </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="card shadow-lg p-3 mb-5 bg-transparent rounded"
                                        ...
                                        <div class="card-header fw-bold bg-transparent"
                                            style="font-size: x-large; backdrop-filter: blur(10px);">Data Pendidikan
                                        </div>
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3" align="right">
                                                <a href="tambah-pendidikan.php" class="btn btn-primary">Add</a>
                                            </div>
                                            <table class="table table-primary table-bordered">
                                                ...
                                                <tbody>
                                                    <?php $no = 1;
                                                    while ($rowPendidikan = mysqli_fetch_assoc($queryPendidikan)): ?>
                                                    <tr>
                                                        <td><?php echo $no++ ?></td>
                                                        <td><?php echo $rowPendidikan['nama_sekolah'] ?></td>
                                                        <td><?php echo $rowPendidikan['tahun'] ?></td>
                                                        <td>
                                                            <a class="btn btn-success btn-sm"
                                                                href="tambah-pendidikan.php?edit=<?php echo $rowPendidikan['id'] ?>">Edit</a>

                                                            <a class="btn btn-danger btn-sm"
                                                                onclick="return confirm('Apakah Anda Yakin untuk Menghapus Data Ini?')"
                                                                href="pendidikan.php?delete=<?php echo $rowPendidikan['id'] ?>">Delete</a>
                                                        </td>
                                                    </tr>
                                                    <?php endwhile ?>
                                                </tbody>
