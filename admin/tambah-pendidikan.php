...
if (isset($_POST['simpan'])) {
    ...
    if (!empty($_FILES['foto']['name'])) {
        ...
        if (!in_array($extFoto, $ext)) {
            ...
            $insert = mysqli_query($koneksi, "INSERT INTO pendidikan (nama_sekolah, tahun, foto) VALUES
            ('$nama_sekolah', '$tahun', '$nama_foto')");
        }
    } else {
        $insert = mysqli_query($koneksi, "INSERT INTO pendidikan (nama_sekolah, tahun) VALUES
            ('$nama_sekolah', '$tahun')");
    }
...
if (isset($_POST['edit'])) {
    ...
    $update = mysqli_query($koneksi, "UPDATE pendidikan SET nama_sekolah='$nama_sekolah',tahun='$tahun' WHERE id='$id'");
                                        ...
                                        <div class="mb-3 row">
                                            <div class="col-sm-6">
                                                ...
                                                <input type="text" class="form-control bg-transparent text-white"
                                                    name="nama_sekolah" placeholder="Masukkan Nama Sekolah Anda"
                                                    required
                                                    value="<?php echo isset($_GET['edit']) ? $rowEdit['nama_sekolah'] : '' ?>">
                                            </div>
                                            <div class="col-sm-6">
