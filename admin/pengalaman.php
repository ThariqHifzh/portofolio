...
$queryPengalaman = mysqli_query($koneksi, "SELECT * FROM pengalaman");
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class=" mb-4 text-white" align="center">
                        <h3 class="fw-bold" style="letter-spacing: 30px;">PENGALAMAN</h1>
                    </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="card shadow-lg p-3 mb-5 bg-transparent rounded"
                                        ...
                                        <div class="card-header fw-bold bg-transparent"
                                            style="font-size: x-large; backdrop-filter: blur(10px);">Data Pengalaman
                                        </div>
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3" align="right">
                                                <a href="tambah-pengalaman.php" class="btn btn-primary">Add</a>
                                            </div>
                                            <table class="table table-primary table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><?php echo $no++ ?></td>
                                                        <td><?php echo $rowPengalaman['perusahaan'] ?></td>
                                                        <td><?php echo $rowPengalaman['tahun'] ?></td>
                                                        <td><?php echo $rowPengalaman['keterangan'] ?></td>
                                                        <td>
                                                            <a class="btn btn-success btn-sm"
                                                                href="tambah-pengalaman.php?edit=<?php echo $rowPengalaman['id'] ?>">Edit</a>

                                                            <a class="btn btn-danger btn-sm"
                                                                onclick="return confirm('Apakah Anda Yakin untuk Menghapus Data Ini?')"
                                                                href="pengalaman.php?delete=<?php echo $rowPengalaman['id'] ?>">Delete</a>
                                                        </td>
                                                    </tr>
                                                    <?php endwhile ?>
                                                </tbody>
