...
$queryOrganisasi = mysqli_query($koneksi, "SELECT * FROM organisasi");
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class=" mb-4 text-white" align="center">
                        <h3 class="fw-bold" style="letter-spacing: 30px;">ORGANISASI</h1>
                    </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="card shadow-lg p-3 mb-5 bg-transparent rounded"
                                        ...
                                        <div class="card-header fw-bold bg-transparent"
                                            style="font-size: x-large; backdrop-filter: blur(10px);">Data Organisasi
                                        </div>
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3" align="right">
                                                <a href="tambah-organisasi.php" class="btn btn-primary">Add</a>
                                            </div>
                                            <table class="table table-primary table-bordered">
                                                ...
                                                <tbody>
                                                    <?php $no = 1;
                                                    while ($rowOrganisasi = mysqli_fetch_assoc($queryOrganisasi)): ?>
                                                    <tr>
                                                        <td><?php echo $no++ ?></td>
                                                        <td><?php echo $rowOrganisasi['nama_organisasi'] ?></td>
                                                        <td><?php echo $rowOrganisasi['tahun'] ?></td>
                                                        <td><?php echo $rowOrganisasi['keterangan'] ?></td>
                                                        <td>
                                                            <a class="btn btn-success btn-sm"
                                                                href="tambah-organisasi.php?edit=<?php echo $rowOrganisasi['id'] ?>">Edit</a>

                                                            <a class="btn btn-danger btn-sm"
                                                                onclick="return confirm('Apakah Anda Yakin untuk Menghapus Data Ini?')"
                                                                href="organisasi.php?delete=<?php echo $rowOrganisasi['id'] ?>">Delete</a>
                                                        </td>
                                                    </tr>
                                                    <?php endwhile ?>
                                                </tbody>
