            ...
            <div class="d-flex">
                <div class="row">
                    ...
                    <div data-aos="fade-right" data-aos-duration="1000" class=""
                        style="margin-top: 250px; margin-left: 90px;">
                        <div class="content">
                            <h3 class="text-white mb-1" style="letter-spacing: 3px;">
                                Ahmad Tariq Hifzhillah</h3>
                            <h1 class="fw-bold mt-50%"
                                style="width: 600px; font-size: 80px; background: linear-gradient(to right, white, blue); -webkit-background-clip: text; color: transparent;">
                                Hi There!</h1>
                            <h1 class="fw-bold"
                                style="width: 900px; font-size: 50px; background: linear-gradient(to right, white, blue); -webkit-background-clip: text; color: transparent;">
                                I am Web Developer</h1>
                            <div class="col-md-4">
                                <p class="text-white mb-1">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                    Consectetur
                                    unde
                                    totam
                                    vel? Aspernatur nihil dolores obcaecati! Fuga, quaerat dolore?</p>
                            </div>
                        </div>
